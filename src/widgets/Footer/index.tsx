  ...
  return (
    <StyledWrapper>
      ...
      <Modal
        ...
        content={
          <>
            Нет логов или сбора данных. Не используем cookies. Но возможно хостинг и(или) люди
            &apos;посередине&apos; собирают какую-то информацию. Также мы не можем отвечать за логи
